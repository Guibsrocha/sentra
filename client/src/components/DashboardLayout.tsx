...
const getMenuItems = (t: any) => [
  ...
  { icon: TrendingUp, label: t('nav.trades'), path: "/trades" },
  { icon: LineChart, label: t('nav.analytics'), path: "/analytics" },
  { icon: Copy, label: t('nav.copyTrading'), path: "/copy-trading" },
  { icon: Users, label: t('nav.traders'), path: "/traders" },
  { icon: BookOpen, label: t('nav.strategies'), path: "/strategies" },
  { icon: Calendar, label: t('nav.calendar'), path: "/calendar" },
  { icon: Bell, label: t('nav.alerts'), path: "/alerts" },
  { icon: CreditCard, label: t('nav.subscriptions'), path: "/subscriptions" },
  { icon: Server, label: t('nav.vps'), path: "/marketplace/vps" },
  { icon: Server, label: t('nav.myVMs'), path: "/my-vms" },
  { icon: Bot, label: t('nav.expertAdvisors'), path: "/marketplace/eas" },

  { icon: Settings, label: t('nav.settings'), path: "/settings" },
];

const getAdminMenuItems = (t: any) => [
  { icon: Shield, label: t('nav.admin'), path: "/admin", adminOnly: true },
  { icon: MessageCircle, label: t('nav.support'), path: "/admin/support", adminOnly: true },
];
  ...
  return (
    <>
      <div className="relative" ref={sidebarRef}>
        ...
        <div
          className={`absolute top-0 right-0 w-1 h-full cursor-col-resize hover:bg-primary/20 transition-colors hidden`}
          onMouseDown={() => {
